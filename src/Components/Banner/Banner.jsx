...
export default function HeroBanner() {
  return (
    <section className="mt-20 rounded-3xl relative max-w-6xl mx-auto h-[350px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <motion.h1
          ...
          className="text-3xl lg:text-4xl italic font-bold text-[#3D365C] drop-shadow-lg"
        >
          Automate your Portugal visa <br />appointments with speed and ease.
          <FaPlaneDeparture className="inline-block mr-3 text-[#7C4585]" />
        </motion.h1>
